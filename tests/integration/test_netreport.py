...
def test_netreport(test_work_dir):
    ...
    # Validate JSON first (network report structure).
    result_json = run_asct("report", ["network", "--format", "json"], output_dir=os.path.join(test_work_dir, "json"))
    ...
    result_stdout = run_asct("report", ["network", "--format", "stdout"], output_dir=None)
    ...
    result_csv = run_asct("report", ["network", "--format", "csv"], output_dir=os.path.join(test_work_dir, "csv"))
